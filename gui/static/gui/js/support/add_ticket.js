...
function support_control_links(elem) {
  ...
  var form = $('#add-ticket-form');
  disable_form_submit(form);  // Disable submit on pressing enter
  form.find(':input:enabled:visible:first').focus();  // Focus on first input field
}
