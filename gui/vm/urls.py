...
urlpatterns = [
    ...
    url(r'^(?P<hostname>[A-Za-z0-9\._-]+)/snapshot/image/form/$', snapshot_image_form, name='vm_snapshot_image_form'),
    ...
    url(r'^(?P<hostname>[A-Za-z0-9\._-]+)/backup/define/form/$', backup_define_form, name='vm_backup_define_form'),
