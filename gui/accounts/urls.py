...
from gui.accounts.views import setlang, logout, DCLoginView
...
if settings.REGISTRATION_ENABLED:
    from gui.accounts.views import forgot_passwd, registration_check, registration_done, forgot_passwd_check, \
        forgot_passwd_done, forgot_passwd_check_done
