    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ostype', models.SmallIntegerField(verbose_name='Guest OS type', choices=[(1, 'Linux'), (2, 'SunOS'), (3, 'BSD'), (4, 'Windows'), (5, 'SunOS Zone'), (6, 'Linux Zone')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('changed', models.DateTimeField(auto_now=True, verbose_name='Last changed')),
                ('status', models.SmallIntegerField(verbose_name='Status', choices=[(1, 'ok'), (2, 'pending')])),
                ('ostype', models.SmallIntegerField(blank=True, null=True, verbose_name='Guest OS type', choices=[(1, 'Linux'), (2, 'SunOS'), (3, 'BSD'), (4, 'Windows')])),
                ('dc', models.ManyToManyField(to='vms.Dc', verbose_name='Datacenter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('changed', models.DateTimeField(auto_now=True, verbose_name='Last changed')),
                ('ostype', models.SmallIntegerField(blank=True, null=True, verbose_name='Guest OS type', choices=[(1, 'Linux'), (2, 'SunOS'), (3, 'BSD'), (4, 'Windows'), (5, 'SunOS Zone'), (6, 'Linux Zone')])),
                ('dc', models.ManyToManyField(to='vms.Dc', verbose_name='Datacenter')),
